...
var stripe = require('stripe')(config.stripeKey);// we recycle it every time
...
router.post('/register', (req,res,next)=>{
	console.log("someone showed up on register: ", req.body);
	// res.json(req.body);
...
router.post('/updateCart', (req, res, next)=>{
	...
	connection.query(getUidQuery,[userToken],(error, results)=>{
		if(error){
			...
			const uid = results[0].id;
			// this is a good token. I know who this is now.
			console.log("uid and productCode", uid, productCode) 
